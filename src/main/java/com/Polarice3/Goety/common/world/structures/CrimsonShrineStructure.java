...
import com.Polarice3.Goety.common.world.structures.pieces.CrimsonShrinePiece;
...
public class CrimsonShrineStructure extends ModStructureTemplate{
    ...
    protected boolean isFeatureChunk(ChunkGenerator chunkGenerator, BiomeProvider biomeSource, long seed, SharedSeedRandom chunkrandom, int chunkX, int chunkZ, Biome biome, ChunkPos chunkPos, NoFeatureConfig featureConfig) {
        ...
        return MainConfig.CrimsonShrineGen.get()
                ...
                && BlockFinder.verticalSpace(chunkGenerator, x, z, 34, 72, 24);
    }

    private boolean isNearBastion(ChunkGenerator p_242782_1_, long p_242782_2_, SharedSeedRandom p_242782_4_, int p_242782_5_, int p_242782_6_) {
        StructureSeparationSettings structureseparationsettings = p_242782_1_.getSettings().getConfig(Structure.BASTION_REMNANT);
        if (structureseparationsettings != null) {
            for (int i = p_242782_5_ - 5; i <= p_242782_5_ + 5; ++i) {
                for (int j = p_242782_6_ - 5; j <= p_242782_6_ + 5; ++j) {
                    ChunkPos chunkpos = Structure.BASTION_REMNANT.getPotentialFeatureChunk(structureseparationsettings, p_242782_2_, p_242782_4_, i, j);
    ...
    public Structure.IStartFactory<NoFeatureConfig> getStartFactory() {
        return CrimsonShrineStructure.Start::new;
    }
    ...
    public static class Start extends StructureStart<NoFeatureConfig> {
        ...
        public void generatePieces(DynamicRegistries dynamicRegistryManager, ChunkGenerator chunkGenerator, TemplateManager templateManagerIn, int chunkX, int chunkZ, Biome biomeIn, NoFeatureConfig config) {
            ...
            CrimsonShrinePiece structure = new CrimsonShrinePiece(templateManagerIn, blockpos, rotation);
