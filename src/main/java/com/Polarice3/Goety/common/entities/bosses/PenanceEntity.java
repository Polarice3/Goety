...
public class PenanceEntity extends CreatureEntity implements IRangedAttackMob {
    ...
    protected void populateDefaultEquipmentSlots(DifficultyInstance difficulty) {
        this.setItemSlot(EquipmentSlotType.MAINHAND, new ItemStack(ModItems.WARPED_SPEAR.get()));
    }
    ...
    public void performRangedAttack(LivingEntity target, float distanceFactor) {
        WarpedSpearEntity spearEntity = new WarpedSpearEntity(this.level, this, new ItemStack(ModItems.WARPED_SPEAR.get()));
    ...
    static class PenanceAttackGoal extends RangedAttackGoal {
        ...
        public boolean canUse() {
            return super.canUse() && this.field_204728_a.stunTick <= 0 && this.field_204728_a.roarTick <= 0 && this.field_204728_a.getMainHandItem().getItem() == ModItems.WARPED_SPEAR.get();
        }
