...
public class ChaosGaleEntity extends DamagingProjectileEntity {
    ...
    public ChaosGaleEntity(EntityType<? extends DamagingProjectileEntity> p_i50173_1_, World p_i50173_2_) {
    ...
    public ChaosGaleEntity(World p_i1794_1_, LivingEntity p_i1794_2_, double p_i1794_3_, double p_i1794_5_, double p_i1794_7_) {
        super(ModEntityType.CHAOSGALE.get(), p_i1794_2_, p_i1794_3_, p_i1794_5_, p_i1794_7_, p_i1794_1_);
    }

    @OnlyIn(Dist.CLIENT)
    public ChaosGaleEntity(World p_i1795_1_, double p_i1795_2_, double p_i1795_4_, double p_i1795_6_, double p_i1795_8_, double p_i1795_10_, double p_i1795_12_) {
        super(ModEntityType.CHAOSGALE.get(), p_i1795_2_, p_i1795_4_, p_i1795_6_, p_i1795_8_, p_i1795_10_, p_i1795_12_, p_i1795_1_);
    }
    ...
    public void tick() {
        ...
        for (MonsterEntity entity : this.level.getEntitiesOfClass(MonsterEntity.class, this.getBoundingBox().inflate(AreaofEffect()))) {
            if (entity != this.getTrueOwner()) {
                entity.targetSelector.addGoal(1, new NearestAttackableTargetGoal<>(entity, LivingEntity.class, 5, false, false, LivingEntity::attackable));
            }
        }
    }
