...
public class DuneSpiderEntity extends SpiderEntity implements IDeadMob {
    ...
    protected void registerGoals() {
        ...
        this.targetSelector.addGoal(2, new DuneSpiderEntity.TargetGoal<>(this, PlayerEntity.class));
        this.targetSelector.addGoal(3, new DuneSpiderEntity.TargetGoal<>(this, IronGolemEntity.class));
    }
    ...
    public boolean doHurtTarget(Entity pEntity) {
        if (super.doHurtTarget(pEntity)) {
            ((LivingEntity)pEntity).addEffect(new EffectInstance(ModEffects.CURSED.get(), 140, 0));
            return true;
        } else {
            return false;
        }
    ...
    public boolean canBeAffected(EffectInstance pPotioneffect) {
        if (pPotioneffect.getEffect() == Effects.POISON || pPotioneffect.getEffect() == ModEffects.CURSED.get()) {
