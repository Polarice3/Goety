...
public class ParasiteEntity extends MonsterEntity {
    ...
    private static final Predicate<LivingEntity> HOSTED = (p_213797_0_) ->
            p_213797_0_.hasEffect(ModEffects.HOSTED.get()) && !(p_213797_0_ instanceof ParasiteEntity) && p_213797_0_.attackable();
    ...
    public boolean doHurtTarget(Entity entityIn) {
        ...
        if (flag && entityIn instanceof LivingEntity) {
            ...
            if (random == 0) {
                ...
                ((LivingEntity) entityIn).addEffect(new EffectInstance(ModEffects.HOSTED.get(), 140 * (int) f));
                this.lifetime = 0;
            }
        }
