...
public class BeldamEntity extends AbstractCultistEntity implements IRangedAttackMob {
        ...
        if (!this.isDrinkingPotion()) {
            ...
            if (pTarget instanceof AbstractRaiderEntity) {
                if (pTarget.isOnFire()){
                    ...
                    if (!(pTarget instanceof IRangedAttackMob) && !pTarget.hasEffect(Effects.DAMAGE_BOOST)){
