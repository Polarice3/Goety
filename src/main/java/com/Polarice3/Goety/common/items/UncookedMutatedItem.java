    ...
    public ItemStack finishUsingItem(ItemStack stack, World worldIn, LivingEntity entityLiving) {
        ...
        if (random == 0) {
            ...
            if (effectinstance1 == null) {
                ...
                EffectInstance effectinstance2 = new EffectInstance(ModRegistryHandler.HOSTED.get(), 600, 0);
                ...
                entityLiving.addEffect(effectinstance);
                EffectInstance effectinstance2 = new EffectInstance(ModRegistryHandler.HOSTED.get(), 600, i);
                entityLiving.addEffect(effectinstance2);
            }
        }
