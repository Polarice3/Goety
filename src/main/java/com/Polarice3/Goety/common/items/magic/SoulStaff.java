...
public class SoulStaff extends SoulWand{
    ...
    public SoulStaff() {
        ...
        builder.put(Attributes.ATTACK_DAMAGE, new AttributeModifier(BASE_ATTACK_DAMAGE_UUID, "Tool modifier",  MainConfig.DarkStaffDamage.get() - 1.0D, AttributeModifier.Operation.ADDITION));
