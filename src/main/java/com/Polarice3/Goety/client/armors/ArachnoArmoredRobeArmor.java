...
public class ArachnoArmoredRobeArmor extends ArmorItem {
    private static final String COOL = "Cool";

    public ArachnoArmoredRobeArmor(IArmorMaterial materialIn, EquipmentSlotType slot, Properties builderIn) {
        ...
        if (MainConfig.SoulRepair.get()) {
            ...
            if (!foundStack.isEmpty() && GoldTotemItem.currentSouls(foundStack) > 0 && stack.isDamaged()) {
                ...
                if (stack.getTag().getInt(COOL) > 20) {
                    ...
                    stack.setDamageValue(stack.getDamageValue() - MainConfig.DarkArmoredRobeRepairAmount.get());
                }
            }
        }
    }
