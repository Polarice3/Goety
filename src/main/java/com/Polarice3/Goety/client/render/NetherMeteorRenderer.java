...
public class NetherMeteorRenderer extends EntityRenderer<NetherMeteorEntity> {
    ...
    protected int getBlockLightLevel(NetherMeteorEntity entityIn, BlockPos partialTicks) {
        return 15;
    }

    public void render(NetherMeteorEntity entityIn, float entityYaw, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn) {
