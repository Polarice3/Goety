...
public class SkeletonMinionClothingLayer <T extends MobEntity & IRangedAttackMob, M extends EntityModel<T>> extends LayerRenderer<T, M> {
    ...
    private static final ResourceLocation STRAY = new ResourceLocation(Goety.MOD_ID, "textures/entity/servants/stray_minion_overlay.png");
    private static final ResourceLocation MOSSY = Goety.location("textures/entity/servants/skeleton/mossy_skeleton_minion_overlay.png");
    ...
    public void render(MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn, T entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        } else if (entitylivingbaseIn instanceof MossySkeletonMinionEntity){
