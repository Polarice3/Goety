...
public class SoulAbsorberTileEntityRenderer extends TileEntityRenderer<SoulAbsorberTileEntity> {
    public SoulAbsorberTileEntityRenderer(TileEntityRendererDispatcher p_i226007_1_) {
        super(p_i226007_1_);
    }

    public void render(SoulAbsorberTileEntity pBlockEntity, float pPartialTicks, MatrixStack pMatrixStack, IRenderTypeBuffer pBuffer, int pCombinedLight, int pCombinedOverlay) {
