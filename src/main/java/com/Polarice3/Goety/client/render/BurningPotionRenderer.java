...
public class BurningPotionRenderer extends EntityRenderer<BurningPotionEntity> {
    private static final ResourceLocation TEXTURE = new ResourceLocation(Goety.MOD_ID,"textures/entity/projectiles/burning_potion.png");
    private static final RenderType field_229044_e_ = RenderType.entityCutoutNoCull(TEXTURE);

    public BurningPotionRenderer(EntityRendererManager renderManagerIn) {
        super(renderManagerIn);
    }

    protected int getBlockLightLevel(BurningPotionEntity entityIn, BlockPos partialTicks) {
        return 15;
    }

    public void render(BurningPotionEntity entityIn, float entityYaw, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn) {
    ...
    public ResourceLocation getTextureLocation(BurningPotionEntity entity) {
        return TEXTURE;
    }
}
