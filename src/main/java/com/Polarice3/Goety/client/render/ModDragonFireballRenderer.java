...
@OnlyIn(Dist.CLIENT)
public class ModDragonFireballRenderer extends EntityRenderer<ModDragonFireballEntity> {
    ...
    public ModDragonFireballRenderer(EntityRendererManager renderManagerIn) {
        super(renderManagerIn);
    }

    protected int getBlockLightLevel(ModDragonFireballEntity pEntity, BlockPos pPos) {
        return 15;
    }

    public void render(ModDragonFireballEntity pEntity, float pEntityYaw, float pPartialTicks, MatrixStack pMatrixStack, IRenderTypeBuffer pBuffer, int pPackedLight) {
    ...
    public ResourceLocation getTextureLocation(ModDragonFireballEntity entity) {
