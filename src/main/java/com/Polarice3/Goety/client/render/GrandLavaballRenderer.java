...
@OnlyIn(Dist.CLIENT)
public class GrandLavaballRenderer extends EntityRenderer<GrandLavaballEntity> {
    ...
    public GrandLavaballRenderer(EntityRendererManager renderManagerIn) {
        super(renderManagerIn);
    }

    protected int getBlockLightLevel(GrandLavaballEntity entityIn, BlockPos partialTicks) {
        return 15;
    }

    public void render(GrandLavaballEntity entityIn, float entityYaw, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn) {
    ...
    public ResourceLocation getTextureLocation(GrandLavaballEntity entity) {
        return TEXTURE;
    }
}
