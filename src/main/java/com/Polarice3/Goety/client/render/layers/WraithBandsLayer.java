...
public class WraithBandsLayer<T extends MobEntity> extends LayerRenderer<T, AbstractWraithModel<T>> {
    ...
    public WraithBandsLayer(IEntityRenderer<T, AbstractWraithModel<T>> p_i50919_1_) {
        super(p_i50919_1_);
    }
