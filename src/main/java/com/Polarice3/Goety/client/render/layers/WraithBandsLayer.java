...
public class WraithBandsLayer<T extends MobEntity> extends LayerRenderer<T, WraithModel<T>> {
    ...
    public WraithBandsLayer(IEntityRenderer<T, WraithModel<T>> p_i50919_1_) {
        super(p_i50919_1_);
    }
