...
public class DesiccatedRenderer extends BipedRenderer<DesiccatedEntity, SkeletonModel<DesiccatedEntity>> {
    private static final ResourceLocation TEXTURES = Goety.location("textures/entity/dead/desiccated.png");

    public DesiccatedRenderer(EntityRendererManager renderManagerIn) {
    ...
    public ResourceLocation getTextureLocation(DesiccatedEntity entity) {
        return TEXTURES;
    }

    protected void setupRotations(DesiccatedEntity pEntityLiving, MatrixStack pMatrixStack, float pAgeInTicks, float pRotationYaw, float pPartialTicks) {
