...
public class ScytheProjectileRenderer extends EntityRenderer<ScytheProjectileEntity> {
    ...
    public ScytheProjectileRenderer(EntityRendererManager renderManagerIn) {
        super(renderManagerIn);
    }

    protected int getBlockLightLevel(ScytheProjectileEntity pEntity, BlockPos pPos) {
        return 15;
    }

    public void render(ScytheProjectileEntity pEntity, float pEntityYaw, float pPartialTicks, MatrixStack pMatrixStack, IRenderTypeBuffer pBuffer, int pPackedLight) {
    ...
    public ResourceLocation getTextureLocation(ScytheProjectileEntity entity) {
