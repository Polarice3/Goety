...
public class DredenBandsLayer<T extends MobEntity> extends LayerRenderer<T, AbstractWraithModel<T>> {
    ...
    public DredenBandsLayer(IEntityRenderer<T, AbstractWraithModel<T>> p_i50919_1_) {
        super(p_i50919_1_);
    }
