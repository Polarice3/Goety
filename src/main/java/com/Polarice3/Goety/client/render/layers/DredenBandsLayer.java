...
public class DredenBandsLayer<T extends MobEntity> extends LayerRenderer<T, DredenModel<T>> {
    private static final ResourceLocation TEXTURES = new ResourceLocation(Goety.MOD_ID, "textures/entity/dreden_minion_bands.png");
    private final DredenModel<T> layerModel = new DredenModel<>();

    public DredenBandsLayer(IEntityRenderer<T, DredenModel<T>> p_i50919_1_) {
        super(p_i50919_1_);
    }
