...
@OnlyIn(Dist.CLIENT)
public class FocusBagScreen extends ContainerScreen<FocusBagContainer> {
    private static final ResourceLocation GUI_TEXTURES = new ResourceLocation(Goety.MOD_ID, "textures/gui/container/focusbag.png");

    public FocusBagScreen(FocusBagContainer p_i51097_1_, PlayerInventory p_i51097_2_, ITextComponent p_i51097_3_) {
