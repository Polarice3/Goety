...
public class DuneSpiderModel<T extends Entity> extends SegmentedModel<T> {
	...
	public DuneSpiderModel() {
		...
		cube_r1.setPos(-5.0F, -4.0F, -4.5F);
		head.addChild(cube_r1);
		setRotationAngle(cube_r1, 0.7854F, 0.0F, 0.0F);
		cube_r1.texOffs(0, 12).addBox(9.0F, -4.0F, -1.5F, 2.0F, 6.0F, 1.0F, 0.0F, false);
		cube_r1.texOffs(0, 12).addBox(-1.0F, -4.0F, -1.5F, 2.0F, 6.0F, 1.0F, 0.0F, false);

		head_r1 = new ModelRenderer(this);
		head_r1.setPos(-2.0F, 2.0F, -10.0F);
		head.addChild(head_r1);
		setRotationAngle(head_r1, 0.0F, 0.4363F, 0.0F);
		head_r1.texOffs(28, 6).addBox(-2.0F, 0.0F, -1.0F, 2.0F, 2.0F, 4.0F, 0.0F, false);

		head_r2 = new ModelRenderer(this);
		head_r2.setPos(2.0F, 2.0F, -10.0F);
		head.addChild(head_r2);
		setRotationAngle(head_r2, 0.0F, -0.4363F, 0.0F);
		head_r2.texOffs(28, 6).addBox(0.0F, 0.0F, -1.0F, 2.0F, 2.0F, 4.0F, 0.0F, true);
		...
		body1.texOffs(44, 22).addBox(-2.0F, -2.0F, 6.0F, 4.0F, 4.0F, 4.0F, 0.0F, false);
