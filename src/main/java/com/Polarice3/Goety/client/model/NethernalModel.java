...
public class NethernalModel extends SegmentedModel<NethernalEntity> {
    ...
    @Override
    public void setupAnim(NethernalEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch){
    ...
    public void prepareMobModel(NethernalEntity entityIn, float limbSwing, float limbSwingAmount, float partialTick) {
