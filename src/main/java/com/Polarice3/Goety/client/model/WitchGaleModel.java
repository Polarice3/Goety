...
public class WitchGaleModel<T extends Entity> extends EntityModel<T> {
    ...
    public WitchGaleModel() {
        ...
        gust1.setPos(0.0F, -6.0F, 0.0F);
        Gust.addChild(gust1);
        gust1.texOffs(48, 32).addBox(-4.0F, -2.0F, -4.0F, 8.0F, 4.0F, 8.0F, 0.0F, false);

        gust2 = new ModelRenderer(this);
        gust2.setPos(0.0F, -10.0F, 0.0F);
        Gust.addChild(gust2);
        gust2.texOffs(48, 0).addBox(-6.0F, -2.0F, -6.0F, 12.0F, 4.0F, 12.0F, 0.0F, false);

        gust3 = new ModelRenderer(this);
        gust3.setPos(0.0F, -14.0F, 0.0F);
        Gust.addChild(gust3);
        gust3.texOffs(0, 32).addBox(-8.0F, -2.0F, -8.0F, 16.0F, 4.0F, 16.0F, 0.0F, false);

        wind = new ModelRenderer(this);
        wind.setPos(0.0F, 0.0F, 0.0F);
        Gust.addChild(wind);
        wind.texOffs(0, 0).addBox(-8.0F, -16.0F, -8.0F, 16.0F, 16.0F, 16.0F, 0.0F, false);
    }
