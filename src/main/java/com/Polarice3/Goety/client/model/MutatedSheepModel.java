...
public class MutatedSheepModel<T extends MutatedSheepEntity> extends EntityModel<T> {
    ...
    public MutatedSheepModel() {
        ...
        body.texOffs(20, 8).addBox(-5.0F, -10.0F, -7.0F, 10.0F, 16.0F, 12.0F, 0.0F, false);

        head = new ModelRenderer(this);
        head.setPos(0.0F, 6.0F, -8.0F);
        head.texOffs(0, 0).addBox(-3.0F, -1.0F, -6.0F, 6.0F, 6.0F, 8.0F, 0.0F, false);

        legbackright = new ModelRenderer(this);
        legbackright.setPos(-3.0F, 12.0F, 7.0F);
        legbackright.texOffs(0, 16).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, 0.0F, false);

        legbackleft = new ModelRenderer(this);
        legbackleft.setPos(3.0F, 12.0F, 7.0F);
        legbackleft.texOffs(0, 16).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, 0.0F, false);

        legfrontright = new ModelRenderer(this);
        legfrontright.setPos(-3.0F, 12.0F, -5.0F);
        legfrontright.texOffs(0, 32).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 8.0F, 4.0F, 0.0F, false);

        legfrontleft = new ModelRenderer(this);
        legfrontleft.setPos(3.0F, 12.0F, -5.0F);
        legfrontleft.texOffs(0, 32).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 8.0F, 4.0F, 0.0F, false);
    }
